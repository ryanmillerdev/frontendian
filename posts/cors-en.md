...
Technically defined, however, simple requests are the combination of a [_simple method_](https://www.w3.org/TR/cors/#simple-method) with a [_simple header_](https://www.w3.org/TR/cors/#simple-header).
