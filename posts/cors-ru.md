...
Однако, говоря конкретно, простые запросы представляют собой комбинацию из [_простых методов_](https://www.w3.org/TR/cors/#simple-method) и [_простых заголовков_](https://www.w3.org/TR/cors/#simple-header).
